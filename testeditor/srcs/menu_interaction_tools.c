...
void	render_interaction_explanations(t_app *app, int start_y)
{
	...
	statics = NULL;
	render_interaction_explanation_1(app, start_y, statics);
	render_interaction_explanation_2(app, start_y, statics);
	render_interaction_explanation_3(app, start_y, statics);
	render_interaction_explanation_4(app, start_y, statics);
}
