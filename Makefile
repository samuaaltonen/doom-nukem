...
#    Updated: 2022/11/22 15:40:05 by saaltone         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES = main.c init.c render_status.c render_ui.c render_text.c \
		...
		player.c player_init.c player_view.c events.c audio.c time.c \
		...
		sector_draw_partial.c sector_draw_sky.c import.c utils.c utils_sdl.c
